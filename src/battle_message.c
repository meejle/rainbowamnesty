...
static const u8 sText_PlayerLostToEnemyTrainer[] = _("You're out of usable Pokémon...\pYou lost against\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidPrizeMoney[] = _("You paid out ¥{B_BUFF1} as the prize\nmoney.\p...\pYou need to get out of here...{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout[] = _("You're out of usable Pokémon...\p");
#if B_WHITEOUT_MONEY >= GEN_4
static const u8 sText_PlayerWhiteout2[] = _("You panicked and lost ¥{B_BUFF1}...\p...\pYou need to get out of here...{PAUSE_UNTIL_PRESS}");
#else
