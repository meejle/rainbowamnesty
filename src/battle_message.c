...
static const u8 sText_TryToLearnMove1[] = _("> {B_BUFF1} is ready to learn\n{B_BUFF2}.\p");
static const u8 sText_TryToLearnMove2[] = _("> But, {B_BUFF1} can't learn more than\nfour moves.\p");
static const u8 sText_TryToLearnMove3[] = _("> Should it forget a move to make room\nfor {B_BUFF2}?");
static const u8 sText_PkmnForgotMove[] = _("> {B_BUFF1} forgot how to use\n{B_BUFF2}.\p");
static const u8 sText_StopLearningMove[] = _("{PAUSE 32}> Should {B_BUFF1} give up on learning\n{B_BUFF2}?");
static const u8 sText_DidNotLearnMove[] = _("> {B_BUFF1} didn't learn\n{B_BUFF2}.\p");
static const u8 sText_UseNextPkmn[] = _("> Will you send out another Pokémon?");
static const u8 sText_AttackMissed[] = _("> {B_ATK_NAME_WITH_PREFIX}'s attack\nmissed!");
static const u8 sText_PkmnProtectedItself[] = _("> {B_DEF_NAME_WITH_PREFIX} protected\nitself!");
static const u8 sText_AvoidedDamage[] = _("> {B_DEF_NAME_WITH_PREFIX} avoided\ndamage thanks to its Ability!");
static const u8 sText_PkmnMakesGroundMiss[] = _("> {B_DEF_NAME_WITH_PREFIX}'s Ability\nmeans it can't be hit by Ground moves!");
static const u8 sText_PkmnAvoidedAttack[] = _("> {B_DEF_NAME_WITH_PREFIX} dodged the\nattack!");
static const u8 sText_ItDoesntAffect[] = _("> The attack has no effect on\n{B_DEF_NAME_WITH_PREFIX}...");
static const u8 sText_AttackerFainted[] = _("> {B_ATK_NAME_WITH_PREFIX} is unable to\nbattle!\p");
static const u8 sText_TargetFainted[] = _("> {B_DEF_NAME_WITH_PREFIX} is unable to\nbattle!\p");
static const u8 sText_PlayerGotMoney[] = _("> You got ¥{B_BUFF1} of prize money!\p");
static const u8 sText_PlayerLostToEnemyTrainer[] = _("> You're out of usable Pokémon...\p> You lost against\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidPrizeMoney[] = _("> You paid out ¥{B_BUFF1} as the prize\nmoney.\p> ...\p> You need to get out of here...{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout[] = _("> You're out of usable Pokémon...\p");
#if B_WHITEOUT_MONEY >= GEN_4
static const u8 sText_PlayerWhiteout2[] = _("> You panicked and lost ¥{B_BUFF1}...\p> ...\p> You need to get out of here...{PAUSE_UNTIL_PRESS}");
#else
static const u8 sText_PlayerWhiteout2[] = _("> You need to get out of here...{PAUSE_UNTIL_PRESS}");
#endif
static const u8 sText_PreventsEscape[] = _("> {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Ability is\npreventing you from escaping!\p");
static const u8 sText_CantEscape2[] = _("> You couldn't get away quickly\nenough...\p");
static const u8 sText_AttackerCantEscape[] = _("> {B_ATK_NAME_WITH_PREFIX} couldn't\nescape...");
static const u8 sText_HitXTimes[] = _("> The attack hit its mark {B_BUFF1}×!");
static const u8 sText_PkmnFellAsleep[] = _("> {B_EFF_NAME_WITH_PREFIX} fell asleep!");
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmade {B_EFF_NAME_WITH_PREFIX} sleep!"); // PROGRESS
...
static const u8 sText_Trainer1WantsToBattle[] = _("> You were challenged by\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}.\p");
...
static const u8 sText_FoePkmnPrefix4[] = _("The opposing ");
...
static const u8 sText_SpAttack[] = _("Special Attack");
static const u8 sText_SpDefense[] = _("Special Defence");
