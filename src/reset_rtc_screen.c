...
static void ShowMessage(const u8 *str)
{
    ...
    AddTextPrinterParameterized(WIN_MSG, FONT_NORMAL_SUBPIXEL, str, 0, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(WIN_TIME, FONT_NORMAL_SUBPIXEL, gText_PresentTime, 0, 1, TEXT_SKIP_DRAW, 0);
        PrintTime(
            WIN_TIME,
            0,
            17,
        ...
        AddTextPrinterParameterized(WIN_TIME, FONT_NORMAL_SUBPIXEL, gText_PreviousTime, 0, 33, TEXT_SKIP_DRAW, 0);
        PrintTime(
            WIN_TIME,
            0,
            49,
