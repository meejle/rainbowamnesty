...
static const struct SpriteFrameImage sPicTable_Ticker_common_Welcom[] = {
    overworld_frame(gObjectEventPic_Ticker_common_Welcom, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_common_Welcom, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_e_to_Mistralto[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_e_to_Mistralto, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_e_to_Mistralto, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_on_Cargo_Serv[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_on_Cargo_Serv, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_on_Cargo_Serv, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_vice__Our[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_vice__Our, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_vice__Our, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_r_slogan_is_Qu[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_r_slogan_is_Qu, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_r_slogan_is_Qu, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_uick_and_Safe[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_uick_and_Safe, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_uick_and_Safe, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton__Due_t[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton__Due_t, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton__Due_t, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_o_the_current[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_o_the_current, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_o_the_current, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_t_situation_we[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_t_situation_we, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_t_situation_we, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_e_are_unable_t[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_e_are_unable_t, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_e_are_unable_t, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_to_ship_to_or_f[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_to_ship_to_or_f, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_to_ship_to_or_f, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_from_Akala_Isl[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_from_Akala_Isl, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_from_Akala_Isl, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_and_or_the_Ae[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_and_or_the_Ae, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_and_or_the_Ae, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_ether_Paradis[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_ether_Paradis, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_ether_Paradis, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_e_in_Alola_Tha[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_e_in_Alola_Tha, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_e_in_Alola_Tha, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_ank_you_for_yo[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_ank_you_for_yo, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_ank_you_for_yo, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_our_understan[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_our_understan, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_our_understan, 8, 4, 1),
};

static const struct SpriteFrameImage sPicTable_Ticker_Mistralton_nding[] = {
    overworld_frame(gObjectEventPic_Ticker_Mistralton_nding, 8, 4, 0),
    overworld_frame(gObjectEventPic_Ticker_Mistralton_nding, 8, 4, 1),
};
