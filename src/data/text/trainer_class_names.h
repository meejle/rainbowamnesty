const u8 gTrainerClassNames[][27] = { // Long enough to fit "Team Rainbow Rocket Leader"
    ...
    [TRAINER_CLASS_TRANSITION_01] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_02] = _("Transition Tester No."),
    ...
    [TRAINER_CLASS_TRANSITION_07] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_08] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_09] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_10] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_11] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_12] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_13] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_14] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_15] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_16] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_17] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_18] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_19] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_20] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_21] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_22] = _("Transition Tester No."),
    [TRAINER_CLASS_TRANSITION_23] = _("Transition Tester No."),
