...
static const u8 sGreatBallDesc[] = _(
    "A good Ball with a\n"
    "higher catch rate\n"
    "than a Poké Ball.{COLOR RED}");

static const u8 sUltraBallDesc[] = _(
    "A better Ball with\n"
    "a higher catch rate\n"
    "than a Great Ball.{COLOR RED}");

static const u8 sMasterBallDesc[] = _(
    "The best Ball that\n"
    "catches a Pokémon\n"
    "without fail.{COLOR RED}");

static const u8 sPremierBallDesc[] = _(
    "A rare Ball made\n"
    "in commemoration\n"
    "of some event.{COLOR RED}");

static const u8 sHealBallDesc[] = _(
    "A remedial Ball\n"
    "that restores\n"
    "caught Pokémon.{COLOR RED}");

static const u8 sNetBallDesc[] = _(
    "A Ball that works\n"
    "well on Water- and\n"
    "Bug-type Pokémon.{COLOR RED}");
...
#else
    "A Poké Ball used in\n"
    "the Entree Forest.{COLOR RED}");
#endif

static const u8 sSafariBallDesc[] = _(
    "A special Ball that\n"
    "is used only in the\n"
    "Safari Zone.{COLOR RED}");
...
static const u8 sParkBallDesc[] = _(
    "A special Ball for\n"
    "the Pal Park.{COLOR RED}");

static const u8 sBeastBallDesc[] = _(
    "A Ball designed to\n"
    "catch Ultra Beasts.{COLOR RED}");
...
static const u8 sHyperPotionDesc[] = _(
    ...
    "a Pokémon by\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "120 points.{COLOR RED}");
#else
    "200 points.{COLOR RED}");
#endif

static const u8 sMaxPotionDesc[] = _(
    "Fully restores the\n"
    "HP of a Pokémon.{COLOR RED}");
...
static const u8 sFreshWaterDesc[] = _(
    ...
    "that restores HP\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "by 30 points.{COLOR RED}");
#else
    "by 50 points.{COLOR RED}");
#endif
...
static const u8 sLemonadeDesc[] = _(
    ...
    "that restores HP\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "by 70 points.{COLOR RED}");
#else
    "by 80 points.{COLOR RED}");
#endif

static const u8 sMoomooMilkDesc[] = _(
    "A nutritious milk\n"
    "that restores HP\n"
    "by 100 points.{COLOR RED}");
...
static const u8 sEnergyRootDesc[] = _(
    ...
    "that restores HP\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "by 120 points.{COLOR RED}");
#else
    "by 200 points.{COLOR RED}");
#endif

static const u8 sHealPowderDesc[] = _(
    "A bitter powder\n"
    "that heals all\n"
    "status problems.{COLOR RED}");

static const u8 sRevivalHerbDesc[] = _(
    "A very bitter herb\n"
    "that revives a\n"
    "fainted Pokémon.{COLOR RED}");
...
static const u8 sYellowFluteDesc[] = _(
    "A glass flute that\n"
    "snaps Pokémon\n"
    "out of confusion.{COLOR RED}");

static const u8 sRedFluteDesc[] = _(
    "A glass flute that\n"
    "snaps Pokémon\n"
    "out of attraction.{COLOR RED}");
...
static const u8 sLureDesc[] = _(
    "Makes Pokémon more\n"
    "likely to appear\n"
    "for 100 steps.{COLOR RED}");

static const u8 sSuperLureDesc[] = _(
    "Makes Pokémon more\n"
    "likely to appear\n"
    "for 200 steps.{COLOR RED}");

static const u8 sMaxLureDesc[] = _(
    "Makes Pokémon more\n"
    "likely to appear\n"
    "for 250 steps.{COLOR RED}");

static const u8 sEscapeRopeDesc[] = _(
    "Use to escape\n"
    "instantly from a\n"
    "cave or a dungeon.{COLOR RED}");
...
static const u8 sGuardSpecDesc[] = _(
    "Prevents stat\n"
    "reduction when\n"
    "used in battle.{COLOR RED}");

// Escape Items
static const u8 sPokeDollDesc[] = _(
    "Use to flee from\n"
    "any battle with\n"
    "a wild Pokémon.{COLOR RED}");
...
static const u8 sHeartScaleDesc[] = _(
    "A lovely scale.\n"
    "It is coveted by\n"
    "collectors.{COLOR RED}");

static const u8 sHoneyDesc[] = _(
    "Sweet honey that\n"
    "attracts wild\n"
    "Pokémon when used.{COLOR RED}");
...
static const u8 sOddKeystoneDesc[] = _(
    "Voices can be heard\n"
    "from this odd stone\n"
    "occasionally.{COLOR RED}");

static const u8 sPrettyFeatherDesc[] = _(
    "A beautiful yet\n"
    "plain feather that\n"
    "does nothing.{COLOR RED}");
...
static const u8 sCoverFossilDesc[] = _(
    "A piece of a\n"
    "prehistoric Poké-\n"
    "mon's back.{COLOR RED}");

static const u8 sPlumeFossilDesc[] = _(
    "A piece of a\n"
    "prehistoric Poké-\n"
    "mon's wing.{COLOR RED}");
...
static const u8 sArmoriteOreDesc[] = _(
    "A rare ore. Can be\n"
    "found in the Isle\n"
    "of Armor at Galar.{COLOR RED}");

static const u8 sDyniteOreDesc[] = _(
    "A mysterious ore.\n"
    "It can be found in\n"
    "Galar's Max Lair.{COLOR RED}");
...
static const u8 sDragonScaleDesc[] = _(
    "A strange scale\n"
    "held by Dragon-\n"
    "type Pokémon.{COLOR RED}");

static const u8 sUpgradeDesc[] = _(
    "A peculiar box made\n"
    "by Silph Co.{COLOR RED}");
...
static const u8 sDecidiumZDesc[] = _(
    "Upgrade Decidu-\n"
    "eye's Spirit Sha-\n"
    "ckle into a Z-Move.{COLOR RED}");

static const u8 sInciniumZDesc[] = _(
    "Upgrade Incine-\n"
    "roar's Darkest La-\n"
    "riat into a Z-Move.{COLOR RED}");
...
static const u8 sMarshadiumZDesc[] = _(
    "Upgrade Marsha-\n"
    "dow's Spectral Thi-\n"
    "ef into a Z-Move.{COLOR RED}");

static const u8 sAloraichiumZDesc[] = _(
    "Upgrade Alolan\n"
    "Raichu's Thunder-\n"
    "bolt into a Z-Move.{COLOR RED}");
...
static const u8 sUltranecroziumZDesc[] = _(
    "A crystal to turn\n"
    "fused Necrozma\n"
    "into a new form.{COLOR RED}");

// Species-specific Held Items
static const u8 sLightBallDesc[] = _(
    "A hold item that\n"
    "raises the Atk and\n"
    "Sp. Atk of Pikachu.{COLOR RED}");

static const u8 sLeekDesc[] = _(
    "A hold item that\n"
    "raises Farfetch'd's\n"
    "critical-hit ratio.{COLOR RED}");

static const u8 sThickClubDesc[] = _(
    "A hold item that \n"
    "raises Cubone or\n"
    "Marowak's Attack.{COLOR RED}");

static const u8 sLuckyPunchDesc[] = _(
    "A hold item that\n"
    "raises Chansey's\n"
    "critical-hit rate.{COLOR RED}");
...
static const u8 sQuickPowderDesc[] = _(
    "An item to be held\n"
    "by Ditto. This odd\n"
    "powder boosts Speed.{COLOR RED}");

static const u8 sDeepSeaScaleDesc[] = _(
    "A hold item that\n"
    "raises the Sp. Def\n"
    "of Clamperl.{COLOR RED}");
...
static const u8 sChoiceBandDesc[] = _(
    "Raises a move's\n"
    "power, but permits\n"
    "only that move.{COLOR RED}");

static const u8 sChoiceSpecsDesc[] = _(
    "Boosts Sp. Atk, but\n"
    "allows the use of\n"
    "only one move.{COLOR RED}");
...
static const u8 sAbsorbBulbDesc[] = _(
    ...
    "a Water-type move.{COLOR RED}");

static const u8 sCellBatteryDesc[] = _(
    "Raises Atk if the\n"
    "holder is hit by an\n"
    "Electric-type move.{COLOR RED}");
...
static const u8 sSnowballDesc[] = _(
    "Raises Atk if its\n"
    "holder is hit by an\n"
    "Ice-type move.{COLOR RED}");

// Misc. Held Items
static const u8 sBrightPowderDesc[] = _(
    "A hold item that\n"
    "casts a glare to\n"
    "reduce accuracy.{COLOR RED}");

static const u8 sWhiteHerbDesc[] = _(
    "A hold item that\n"
    "restores any\n"
    "lowered stat.{COLOR RED}");

static const u8 sExpShareDesc[] = _(
    "A hold item that\n"
    "gets Exp. points\n"
    "from battles.{COLOR RED}");

static const u8 sQuickClawDesc[] = _(
    "A hold item that\n"
    "occasionally allows\n"
    "the first strike.{COLOR RED}");

static const u8 sSootheBellDesc[] = _(
    "A hold item that\n"
    "calms spirits and\n"
    "fosters friendship.{COLOR RED}");
...
static const u8 sMentalHerbDesc[] = _(
    "A hold item that\n"
    "snaps Pokémon out\n"
    "of infatuation.{COLOR RED}");
#endif

static const u8 sKingsRockDesc[] = _(
    "A hold item that\n"
    "may cause flinching\n"
    "when the foe is hit.{COLOR RED}");
...
static const u8 sSmokeBallDesc[] = _(
    "A hold item that\n"
    "assures fleeing\n"
    "from wild Pokémon.{COLOR RED}");

static const u8 sFocusBandDesc[] = _(
    "A hold item that\n"
    "occasionally\n"
    "prevents fainting.{COLOR RED}");

static const u8 sLuckyEggDesc[] = _(
    "A hold item that\n"
    "boosts Exp. points\n"
    "earned in battle.{COLOR RED}");
...
static const u8 sBlackSludgeDesc[] = _(
    "Gradually restores\n"
    "HP of Poison-types.\n"
    "Damages others.{COLOR RED}");

static const u8 sGripClawDesc[] = _(
    "Makes binding moves\n"
    "used by the holder\n"
    "go on for 7 turns.{COLOR RED}");

static const u8 sStickyBarbDesc[] = _(
    "Damages the holder\n"
    "each turn. May latch\n"
    "on to foes.{COLOR RED}");

static const u8 sShedShellDesc[] = _(
    "Enables the holder\n"
    "to switch out of\n"
    "battle without fail.{COLOR RED}");

static const u8 sBigRootDesc[] = _(
    "A held item that\n"
    "boosts the power of\n"
    "HP-stealing moves.{COLOR RED}");
...
static const u8 sEvioliteDesc[] = _(
    "Raises the Def and\n"
    "Sp. Def of Pokémon\n"
    "that can evolve.{COLOR RED}");

static const u8 sFloatStoneDesc[] = _(
    "It's so light that\n"
    "when held, it halves\n"
    "a Pokémon's weight.{COLOR RED}");
...
static const u8 sAirBalloonDesc[] = _(
    "Elevates the holder\n"
    "in the air. If hit,\n"
    "this item will burst.{COLOR RED}");
...
static const u8 sLumBerryDesc[] = _(
    "A hold item that\n"
    "heals any status\n"
    "problem in battle.{COLOR RED}");

static const u8 sSitrusBerryDesc[] = _(
#if I_SITRUS_BERRY_HEAL >= GEN_4
    "A hold item that\n"
    "restores the user's\n"
    "HP a little.{COLOR RED}");
#else
    "A hold item that\n"
    "restores 30 HP in\n"
    "battle.{COLOR RED}");
...
static const u8 sLansatBerryDesc[] = _(
    "A hold item that\n"
    "ups the critical-\n"
    "hit rate in a pinch.{COLOR RED}");

static const u8 sStarfBerryDesc[] = _(
    "A hold item that\n"
    "sharply boosts a\n"
    "stat in a pinch.{COLOR RED}");
...
static const u8 sKeeBerryDesc[] = _(
    "If hit by a physical\n"
    "move, it raises the\n"
    "Defense a bit.{COLOR RED}");

static const u8 sMarangaBerryDesc[] = _(
    "If hit by a special\n"
    "move, it raises the\n"
    "Sp. Def. a bit.{COLOR RED}");

static const u8 sEnigmaBerryEReaderDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow a mystery.{COLOR RED}");

// TMs/HMs
static const u8 sTM01Desc[] = _(
    "Powerful, but makes\n"
    "the user flinch if\n"
    "hit by the foe.{COLOR RED}");

static const u8 sTM02Desc[] = _(
    "Hooks and slashes\n"
    "the foe with long,\n"
    "sharp claws.{COLOR RED}");

static const u8 sTM03Desc[] = _(
    "Generates an\n"
    "ultrasonic wave\n"
    "that may confuse.{COLOR RED}");
...
static const u8 sTM05Desc[] = _(
    "A savage roar that\n"
    "makes the foe flee \n"
    "to end the battle.{COLOR RED}");

static const u8 sTM06Desc[] = _(
    "Poisons the foe\n"
    "with a toxin that\n"
    "gradually worsens.{COLOR RED}");

static const u8 sTM07Desc[] = _(
    "Creates a hailstorm\n"
    "that damages all\n"
    "types except Ice.{COLOR RED}");

static const u8 sTM08Desc[] = _(
    "Bulks up the body\n"
    "to boost both\n"
    "Attack & Defense.{COLOR RED}");
...
static const u8 sTM10Desc[] = _(
    "The attack power\n"
    "varies among\n"
    "different Pokémon.{COLOR RED}");

static const u8 sTM11Desc[] = _(
    "Raises the power of\n"
    "Fire-type moves\n"
    "for 5 turns.{COLOR RED}");

static const u8 sTM12Desc[] = _(
    "Enrages the foe so\n"
    "it can only use\n"
    "attack moves.{COLOR RED}");

static const u8 sTM13Desc[] = _(
    "Fires an icy cold\n"
    "beam that may\n"
    "freeze the foe.{COLOR RED}");

static const u8 sTM14Desc[] = _(
    "A brutal snow-and-\n"
    "wind attack that\n"
    "may freeze the foe.{COLOR RED}");
...
static const u8 sTM16Desc[] = _(
    "Creates a wall of\n"
    "light that lowers\n"
    "Sp. Atk damage.{COLOR RED}");

static const u8 sTM17Desc[] = _(
    "Negates all damage,\n"
    "but may fail if used\n"
    "in succession.{COLOR RED}");
...
static const u8 sTM19Desc[] = _(
    "Recovers half the\n"
    "HP of the damage \n"
    "this move inflicts.{COLOR RED}");

static const u8 sTM20Desc[] = _(
    "Prevents status\n"
    "abnormality with a\n"
    "mystical power.{COLOR RED}");

static const u8 sTM21Desc[] = _(
    "The less the user\n"
    "likes you, the more\n"
    "powerful this move.{COLOR RED}");

static const u8 sTM22Desc[] = _(
    "Absorbs sunlight in\n"
    "the 1st turn, then\n"
    "attacks next turn.{COLOR RED}");

static const u8 sTM23Desc[] = _(
    "Slams the foe with\n"
    "a hard tail. It may\n"
    "lower Defense.{COLOR RED}");

static const u8 sTM24Desc[] = _(
    "A powerful electric\n"
    "attack that may\n"
    "cause paralysis.{COLOR RED}");

static const u8 sTM25Desc[] = _(
    "Strikes the foe\n"
    "with a thunderbolt.\n"
    "It may paralyze.{COLOR RED}");

static const u8 sTM26Desc[] = _(
    "Causes a quake\n"
    "that has no effect\n"
    "on flying foes.{COLOR RED}");
...
static const u8 sTM28Desc[] = _(
    "Digs underground\n"
    "the 1st turn, then\n"
    "strikes next turn.{COLOR RED}");

static const u8 sTM29Desc[] = _(
    "A powerful psychic\n"
    "attack that may\n"
    "lower Sp. Def.{COLOR RED}");
...
static const u8 sTM31Desc[] = _(
    "Destroys barriers\n"
    "like Light Screen\n"
    "and causes damage.{COLOR RED}");

static const u8 sTM32Desc[] = _(
    "Creates illusory\n"
    "copies to enhance\n"
    "elusiveness.{COLOR RED}");

static const u8 sTM33Desc[] = _(
    "Creates a wall of\n"
    "light that weakens\n"
    "physical attacks.{COLOR RED}");

static const u8 sTM34Desc[] = _(
    "Zaps the foe with a\n"
    "jolt of electricity\n"
    "that never misses.{COLOR RED}");
...
static const u8 sTM37Desc[] = _(
    "Causes a sandstorm\n"
    "that hits the foe\n"
    "over several turns.{COLOR RED}");

static const u8 sTM38Desc[] = _(
    "A powerful fire\n"
    "attack that may\n"
    "burn the foe.{COLOR RED}");

static const u8 sTM39Desc[] = _(
    "Stops the foe from\n"
    "moving with rocks.\n"
    "May lower Speed.{COLOR RED}");

static const u8 sTM40Desc[] = _(
    "An extremely fast\n"
    "attack that can't\n"
    "be avoided.{COLOR RED}");

static const u8 sTM41Desc[] = _(
    "Prevents the foe\n"
    "from using the same\n"
    "move in a row.{COLOR RED}");

static const u8 sTM42Desc[] = _(
    "Raises Attack when\n"
    "poisoned, burned,\n"
    "or paralyzed.{COLOR RED}");

static const u8 sTM43Desc[] = _(
    "Adds an effect to\n"
    "attack depending\n"
    "on the location.{COLOR RED}");

static const u8 sTM44Desc[] = _(
    "The user sleeps for\n"
    "2 turns to restore\n"
    "health and status.{COLOR RED}");
...
static const u8 sTM46Desc[] = _(
    "While attacking,\n"
    "it may steal the\n"
    "foe's held item.{COLOR RED}");

static const u8 sTM47Desc[] = _(
    "Spreads hard-\n"
    "edged wings and\n"
    "slams into the foe.{COLOR RED}");

static const u8 sTM48Desc[] = _(
    "Switches abilities\n"
    "with the foe on the\n"
    "turn this is used.{COLOR RED}");

static const u8 sTM49Desc[] = _(
    "Steals the effects\n"
    "of the move the foe\n"
    "is trying to use.{COLOR RED}");

static const u8 sTM50Desc[] = _(
    "Enables full-power\n"
    "attack, but sharply\n"
    "lowers Sp. Atk.{COLOR RED}");
...
static const u8 sHM05Desc[] = _(
    "Looses a powerful\n"
    "blast of light that\n"
    "reduces accuracy.{COLOR RED}");

static const u8 sHM06Desc[] = _(
    "A rock-crushingly\n"
    "tough attack that\n"
    "may lower Defense.{COLOR RED}");

static const u8 sHM07Desc[] = _(
    "Attacks the foe\n"
    "with enough power\n"
    "to climb waterfalls.{COLOR RED}");
...
static const u8 sOvalCharmDesc[] = _(
    "Raises the chance\n"
    "of finding eggs\n"
    "at the daycare.{COLOR RED}");

static const u8 sShinyCharmDesc[] = _(
    "A charm that will\n"
    "raise the chance\n"
    "of Shiny Pokémon.{COLOR RED}");

static const u8 sCatchingCharmDesc[] = _(
    "A charm that raises\n"
    "the chance of\n"
    "Critical Captures.{COLOR RED}");
...
static const u8 sGracideaDesc[] = _(
    "Bouquets made with\n"
    "it are offered as a\n"
    "token of gratitude.{COLOR RED}");

static const u8 sRevealGlassDesc[] = _(
    "This glass returns\n"
    "a Pokémon back to\n"
    "its original form.{COLOR RED}");

static const u8 sDNASplicersDesc[] = _(
    "Splicer that fuses\n"
    "Kyurem and a\n"
    "certain Pokémon.{COLOR RED}");
...
static const u8 sDowsingMachineDesc[] = _(
    ...
    "item by sound.{COLOR RED}");

static const u8 sTownMapDesc[] = _(
    "Can be viewed\n"
    "anytime. Shows your\n"
    "present location.{COLOR RED}");

static const u8 sVsSeekerDesc[] = _(
    "A rechargeable unit\n"
    "that flags battle-\n"
    "ready Trainers.{COLOR RED}");
...
static const u8 sFameCheckerDesc[] = _(
    "Stores information\n"
    "on famous people\n"
    "for instant recall.{COLOR RED}");

static const u8 sTeachyTVDesc[] = _(
    "A TV set tuned to\n"
    "an advice program\n"
    "for Trainers.{COLOR RED}");
