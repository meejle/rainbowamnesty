...
static const u8 sPokeBallDesc[] = _(
    "A tool used for\n"
    "catching wild\n"
    "Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGreatBallDesc[] = _(
    "A good Ball with a\n"
    "higher catch rate\n"
    "than a Poké Ball.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sUltraBallDesc[] = _(
    "A better Ball with\n"
    "a higher catch rate\n"
    "than a Great Ball.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMasterBallDesc[] = _(
    "The best Ball that\n"
    "catches a Pokémon\n"
    "without fail.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPremierBallDesc[] = _(
    "A rare Ball made\n"
    "in commemoration\n"
    "of some event.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sHealBallDesc[] = _(
    "A remedial Ball\n"
    "that restores\n"
    "caught Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sNetBallDesc[] = _(
    "A Ball that works\n"
    "well on Water- and\n"
    "Bug-type Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sDiveBallDesc[] = _(
    "A Ball that works\n"
    "better on Pokémon\n"
    "on the ocean floor.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDuskBallDesc[] = _(
    "Works well if\n"
    "used in a\n"
    "dark place.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTimerBallDesc[] = _(
    "A Ball that gains\n"
    "power in battles\n"
    "taking many turns.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sQuickBallDesc[] = _(
    "Works well if\n"
    "used on the\n"
    "first turn.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRepeatBallDesc[] = _(
    "A Ball that works\n"
    "better on Pokémon\n"
    "caught before.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLuxuryBallDesc[] = _(
    "A cozy Ball that\n"
    "makes Pokémon\n"
    "more friendly.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLevelBallDesc[] = _(
    "A Ball that works\n"
    "well on lower\n"
    "level Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLureBallDesc[] = _(
    "A Ball that works\n"
    "well on fished\n"
    "up Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMoonBallDesc[] = _(
    "A Ball that works\n"
    "well on Moon\n"
    "Stone users.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sFriendBallDesc[] = _(
    "A Ball that makes\n"
    "a Pokémon friendly\n"
    "when caught.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLoveBallDesc[] = _(
    "Works well on\n"
    "Pokémon of the\n"
    "opposite gender.{COLOR RED}{SHADOW LIGHT_RED}");
...
#else
    "A Poké Ball used in\n"
    "the Entree Forest.{COLOR RED}{SHADOW LIGHT_RED}");
#endif

static const u8 sSafariBallDesc[] = _(
    "A special Ball that\n"
    "is used only in the\n"
    "Safari Zone.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSportBallDesc[] = _(
    "A special Ball used\n"
    "in the Bug-Catching\n"
    "Contest.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sParkBallDesc[] = _(
    "A special Ball for\n"
    "the Pal Park.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBeastBallDesc[] = _(
    "A Ball designed to\n"
    "catch Ultra Beasts.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sPotionDesc[] = _(
    "Restores the HP of\n"
    "a Pokémon by\n"
    "20 points.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSuperPotionDesc[] = _(
    "Restores the HP of\n"
    "a Pokémon by\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "60 points.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "50 points.{COLOR RED}{SHADOW LIGHT_RED}");
#endif
...
static const u8 sHyperPotionDesc[] = _(
    ...
    "a Pokémon by\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "120 points.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "200 points.{COLOR RED}{SHADOW LIGHT_RED}");
#endif

static const u8 sMaxPotionDesc[] = _(
    "Fully restores the\n"
    "HP of a Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sReviveDesc[] = _(
    "Revives a fainted\n"
    "Pokémon with half\n"
    "its HP.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFreshWaterDesc[] = _(
    ...
    "that restores HP\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "by 30 points.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "by 50 points.{COLOR RED}{SHADOW LIGHT_RED}");
#endif
...
static const u8 sSodaPopDesc[] = _(
    ...
    "by 50 points.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "by 60 points.{COLOR RED}{SHADOW LIGHT_RED}");
#endif
...
static const u8 sLemonadeDesc[] = _(
    ...
    "that restores HP\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "by 70 points.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "by 80 points.{COLOR RED}{SHADOW LIGHT_RED}");
#endif

static const u8 sMoomooMilkDesc[] = _(
    "A nutritious milk\n"
    "that restores HP\n"
    "by 100 points.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sEnergyRootDesc[] = _(
    ...
    "that restores HP\n"
#if I_HEALTH_RECOVERY >= GEN_7
    "by 120 points.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "by 200 points.{COLOR RED}{SHADOW LIGHT_RED}");
#endif

static const u8 sHealPowderDesc[] = _(
    "A bitter powder\n"
    "that heals all\n"
    "status problems.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRevivalHerbDesc[] = _(
    "A very bitter herb\n"
    "that revives a\n"
    "fainted Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sBurnHealDesc[] = _(
    "Heals Pokémon\n"
    "of a burn.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFullHealDesc[] = _(
    "Heals all the\n"
    "status problems of\n"
    "one Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sEtherDesc[] = _(
    "Restores the PP\n"
    "of a selected move\n"
    "by 10.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMaxEtherDesc[] = _(
    "Fully restores the\n"
    "PP of a selected\n"
    "move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sElixirDesc[] = _(
    "Restores the PP\n"
    "of all moves by 10.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMaxElixirDesc[] = _(
    "Fully restores the\n"
    "PP of a Pokémon's\n"
    "moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBerryJuiceDesc[] = _(
    "A 100% pure juice\n"
    "that restores HP\n"
    "by 20 points.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sHPUpDesc[] = _(
    "Raises the base HP\n"
    "of one Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sPPMaxDesc[] = _(
    "Raises the PP of a\n"
    "move to its maximum\n"
    "points.{COLOR RED}{SHADOW LIGHT_RED}");

// EV Feathers
static const u8 sHealthFeatherDesc[] = _(
    "An item that raises\n"
    "the base HP of\n"
    "a Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sResistFeatherDesc[] = _(
    "An item that raises\n"
    "the base Defense\n"
    "of a Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sAbilityCapsuleDesc[] = _(
    "Switches a Poké-\n"
    "mon's ability.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAbilityPatchDesc[] = _(
    "Turns the ability\n"
    "of a Pokémon into\n"
    "a rare ability.{COLOR RED}{SHADOW LIGHT_RED}");

// Mints
static const u8 sLonelyMintDesc[] = _(
    "Can be smelled. It\n"
    "ups Attack, but\n"
    "reduces Defense.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAdamantMintDesc[] = _(
    "Can be smelled. It\n"
    "ups Attack, but\n"
    "reduces Sp. Atk.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sNaughtyMintDesc[] = _(
    "Can be smelled. It\n"
    "ups Attack, but\n"
    "reduces Sp. Def.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBraveMintDesc[] = _(
    "Can be smelled. It\n"
    "ups Attack, but\n"
    "reduces Speed.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBoldMintDesc[] = _(
    "Can be smelled. It\n"
    "ups Defense, but\n"
    "reduces Attack.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRareCandyDesc[] = _(
    "Raises the level\n"
    "of a Pokémon by\n"
    "one.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sExpCandyXSDesc[] = _(
    "Gives a very small\n"
    "amount of Exp. to\n"
    "a single Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sDynamaxCandyDesc[] = _(
    "Raises the Dynamax\n"
    "Level of a single\n"
    "Pokémon by one.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sYellowFluteDesc[] = _(
    "A glass flute that\n"
    "snaps Pokémon\n"
    "out of confusion.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRedFluteDesc[] = _(
    "A glass flute that\n"
    "snaps Pokémon\n"
    "out of attraction.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sWhiteFluteDesc[] = _(
    "A glass flute that\n"
    "lures wild Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

// Encounter Modifiers
static const u8 sRepelDesc[] = _(
    "Repels weak wild\n"
    "Pokémon for 100\n"
    "steps.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sLureDesc[] = _(
    "Makes Pokémon more\n"
    "likely to appear\n"
    "for 100 steps.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSuperLureDesc[] = _(
    "Makes Pokémon more\n"
    "likely to appear\n"
    "for 200 steps.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMaxLureDesc[] = _(
    "Makes Pokémon more\n"
    "likely to appear\n"
    "for 250 steps.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sEscapeRopeDesc[] = _(
    "Use to escape\n"
    "instantly from a\n"
    "cave or a dungeon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sXAttackDesc[] = _(
    ...
    "Sharply raises stat\n"
    "Attack during\n"
    "one battle.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "Raises the stat\n"
    "Attack during one\n"
    "battle.{COLOR RED}{SHADOW LIGHT_RED}");
#endif
...
static const u8 sXAccuracyDesc[] = _(
    ...
    "Raises accuracy\n"
    "of attack moves\n"
    "during one battle.{COLOR RED}{SHADOW LIGHT_RED}");
#endif
...
static const u8 sGuardSpecDesc[] = _(
    "Prevents stat\n"
    "reduction when\n"
    "used in battle.{COLOR RED}{SHADOW LIGHT_RED}");

// Escape Items
static const u8 sPokeDollDesc[] = _(
    "Use to flee from\n"
    "any battle with\n"
    "a wild Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sMaxMushroomsDesc[] = _(
    "Raises every stat\n"
    "during one battle\n"
    "by one stage.{COLOR RED}{SHADOW LIGHT_RED}");

// Treasures
static const u8 sBottleCapDesc[] = _(
    "A beautiful bottle\n"
    "cap that gives off\n"
    "a silver gleam.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGoldBottleCapDesc[] = _(
    "A beautiful bottle\n"
    "cap that gives off\n"
    "a golden gleam.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sNuggetDesc[] = _(
    "A nugget of pure\n"
    "gold. Can be sold at\n"
    "a high price.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBigNuggetDesc[] = _(
    "A big nugget made\n"
    "of gold, sellable\n"
    "at a high price.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTinyMushroomDesc[] = _(
    "A plain mushroom\n"
    "that would sell\n"
    "at a cheap price.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBigMushroomDesc[] = _(
    "A rare mushroom\n"
    "that would sell at a\n"
    "high price.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sPearlDesc[] = _(
    "A pretty pearl\n"
    "that would sell at a\n"
    "cheap price.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sStarPieceDesc[] = _(
    "A red gem shard.\n"
    "It would sell for a\n"
    "very high price.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sShoalSaltDesc[] = _(
    "Salt obtained from\n"
    "deep inside the\n"
    "Shoal Cave.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRedShardDesc[] = _(
    "A shard from an\n"
    "ancient item. Can\n"
    "be sold cheaply.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sHeartScaleDesc[] = _(
    "A lovely scale.\n"
    "It is coveted by\n"
    "collectors.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sHoneyDesc[] = _(
    "Sweet honey that\n"
    "attracts wild\n"
    "Pokémon when used.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sOddKeystoneDesc[] = _(
    "Voices can be heard\n"
    "from this odd stone\n"
    "occasionally.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPrettyFeatherDesc[] = _(
    "A beautiful yet\n"
    "plain feather that\n"
    "does nothing.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sStrangeSouvenirDesc[] = _(
    "An ornament that\n"
    "depicts a Pokémon\n"
    "from Alola.{COLOR RED}{SHADOW LIGHT_RED}");

// Fossils
static const u8 sHelixFossilDesc[] = _(
    "A piece of an\n"
    "ancient marine\n"
    "Pokémon's seashell.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDomeFossilDesc[] = _(
    "A piece of an\n"
    "ancient marine\n"
    "Pokémon's shell.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sOldAmberDesc[] = _(
    "A stone containing\n"
    "the genes of an\n"
    "ancient Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRootFossilDesc[] = _(
    "A fossil of an\n"
    "ancient, seafloor-\n"
    "dwelling Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sArmorFossilDesc[] = _(
    "A piece of a\n"
    "prehistoric Poké-\n"
    "mon's head.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sCoverFossilDesc[] = _(
    "A piece of a\n"
    "prehistoric Poké-\n"
    "mon's back.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPlumeFossilDesc[] = _(
    "A piece of a\n"
    "prehistoric Poké-\n"
    "mon's wing.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sJawFossilDesc[] = _(
    "A piece of a prehis-\n"
    "toric Pokémon's\n"
    "large jaw.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSailFossilDesc[] = _(
    "A piece of a prehis-\n"
    "toric Pokémon's\n"
    "skin sail.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sFossilizedBirdDesc[] = _(
    "A fossil of an\n"
    "ancient, sky-\n"
    "soaring Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFossilizedDrakeDesc[] = _(
    "A fossil of an\n"
    "ancient, land-\n"
    "roaming Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sGrowthMulchDesc[] = _(
    "A fertilizer that\n"
    "accelerates the\n"
    "growth of Berries.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sStableMulchDesc[] = _(
    "A fertilizer that\n"
    "ups the life time\n"
    "of Berry trees.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGooeyMulchDesc[] = _(
    "A fertilizer that\n"
    "makes more Berries\n"
    "regrow after fall.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRichMulchDesc[] = _(
    "A fertilizer that\n"
    "ups the number of\n"
    "Berries harvested.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSurpriseMulchDesc[] = _(
    "A fertilizer that\n"
    "ups the chance of\n"
    "Berry mutations.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBoostMulchDesc[] = _(
    "A fertilizer that\n"
    "ups the dry speed\n"
    "of soft soil.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAmazeMulchDesc[] = _(
    "A fertilizer Rich\n"
    "Surprising and\n"
    "Boosting as well.{COLOR RED}{SHADOW LIGHT_RED}");

// Apricorns
static const u8 sRedApricornDesc[] = _(
    "A red apricorn.\n"
    "It assails your\n"
    "nostrils.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBlueApricornDesc[] = _(
    "A blue apricorn.\n"
    "It smells a bit\n"
    "like grass.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sYellowApricornDesc[] = _(
    "A yellow apricorn.\n"
    "It has an invigor-\n"
    "ating scent.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGreenApricornDesc[] = _(
    "A green apricorn.\n"
    "It has a strange,\n"
    "aromatic scent.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPinkApricornDesc[] = _(
    "A pink apricorn.\n"
    "It has a nice,\n"
    "sweet scent.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWhiteApricornDesc[] = _(
    "A white apricorn.\n"
    "It doesn't smell\n"
    "like anything.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBlackApricornDesc[] = _(
    "A black apricorn.\n"
    "It has an inde-\n"
    "scribable scent.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWishingPieceDesc[] = _(
    "Throw into a\n"
    "{PKMN} Den to attract\n"
    "Dynamax Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGalaricaTwigDesc[] = _(
    "A twig from a tree\n"
    "in Galar called\n"
    "Galarica.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sArmoriteOreDesc[] = _(
    "A rare ore. Can be\n"
    "found in the Isle\n"
    "of Armor at Galar.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDyniteOreDesc[] = _(
    "A mysterious ore.\n"
    "It can be found in\n"
    "Galar's Max Lair.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sBeadMailDesc[] = _(
    "Mail featuring a\n"
    "sketch of the\n"
    "holding Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFabMailDesc[] = _(
    "A gorgeous-print\n"
    "Mail to be held\n"
    "by a Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sDragonScaleDesc[] = _(
    "A strange scale\n"
    "held by Dragon-\n"
    "type Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sUpgradeDesc[] = _(
    "A peculiar box made\n"
    "by Silph Co.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sProtectorDesc[] = _(
    "Loved by a certain\n"
    "Pokémon. It's stiff\n"
    "and heavy.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sElectirizerDesc[] = _(
    "Loved by a certain\n"
    "Pokémon. It's full\n"
    "of electric energy.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMagmarizerDesc[] = _(
    "Loved by a certain\n"
    "Pokémon. It's full\n"
    "of magma energy.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDubiousDiscDesc[] = _(
    "A transparent device\n"
    "overflowing with\n"
    "dubious data.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sReaperClothDesc[] = _(
    "Loved by a certain\n"
    "Pokémon. Imbued with\n"
    "spiritual energy.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPrismScaleDesc[] = _(
    "A mysterious scale\n"
    "that evolves certain\n"
    "Pokémon. It shines.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWhippedDreamDesc[] = _(
    "A soft and sweet\n"
    "treat loved by\n"
    "a certain Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sOvalStoneDesc[] = _(
    "Makes a certain\n"
    "Pokémon evolve. It's\n"
    "shaped like an egg.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sStrawberrySweetDesc[] = _(
    "Strawberry-shaped\n"
    "sweet loved by\n"
    "Milcery.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sEverstoneDesc[] = _(
    "A wondrous hold\n"
    "item that prevents\n"
    "evolution.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRedNectarDesc[] = _(
    "Flower nectar that\n"
    "changes the form\n"
    "of certain Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFlamePlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Fire-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSplashPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Water-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sZapPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of Elec-\n"
    "tric-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMeadowPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Grass-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sIciclePlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Ice-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sFistPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of Fight-\n"
    "ing-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sToxicPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Poison-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sEarthPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Ground-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSkyPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Flying-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMindPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of Psy\n"
    "chic-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sInsectPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Bug-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sStonePlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Rock-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSpookyPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Ghost-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDracoPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Dragon-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDreadPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Dark-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sIronPlateDesc[] = _(
    "A tablet that ups\n"
    "the power of\n"
    "Steel-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPixiePlateDesc[] = _(
    "A stone tablet that\n"
    "boosts the power of\n"
    "Fairy-type moves.{COLOR RED}{SHADOW LIGHT_RED}");

// Drives
static const u8 sDouseDriveDesc[] = _(
    "Changes Genesect's\n"
    "Techno Blast to\n"
    "Water-type.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sShockDriveDesc[] = _(
    "Changes Genesect's\n"
    "Techno Blast to\n"
    "Electric-type.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBurnDriveDesc[] = _(
    "Changes Genesect's\n"
    "Techno Blast to\n"
    "Fire-type.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sChillDriveDesc[] = _(
    "Changes Genesect's\n"
    "Techno Blast to\n"
    "Ice-type.{COLOR RED}{SHADOW LIGHT_RED}");

// Memories
static const u8 sFireMemoryDesc[] = _(
    "A disc with Fire\n"
    "type data. It swaps\n"
    "Silvally's type.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRustedSwordDesc[] = _(
    "A rusty sword. A\n"
    "hero used it to\n"
    "halt a disaster.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRedOrbDesc[] = _(
    "A red, glowing orb\n"
    "said to contain an\n"
    "ancient power.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sVenusauriteDesc[] = _(
    "This stone enables\n"
    "Venusaur to Mega\n"
    "Evolve in battle.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sNormalGemDesc[] = _(
    "Increases the\n"
    "power of Normal\n"
    "Type moves.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sNormaliumZDesc[] = _(
    "Upgrade Normal-\n"
    "type moves into\n"
    "Z-Moves.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sPikaniumZDesc[] = _(
    "Upgrade Pikachu's\n"
    "Volt Tackle\n"
    "into a Z-Move.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sMewniumZDesc[] = _(
    "Upgrade Mew's\n"
    "Psychic into\n"
    "a Z-Move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDecidiumZDesc[] = _(
    "Upgrade Decidu-\n"
    "eye's Spirit Sha-\n"
    "ckle into a Z-Move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sInciniumZDesc[] = _(
    "Upgrade Incine-\n"
    "roar's Darkest La-\n"
    "riat into a Z-Move.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sMarshadiumZDesc[] = _(
    "Upgrade Marsha-\n"
    "dow's Spectral Thi-\n"
    "ef into a Z-Move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAloraichiumZDesc[] = _(
    "Upgrade Alolan\n"
    "Raichu's Thunder-\n"
    "bolt into a Z-Move.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sUltranecroziumZDesc[] = _(
    "A crystal to turn\n"
    "fused Necrozma\n"
    "into a new form.{COLOR RED}{SHADOW LIGHT_RED}");

// Species-specific Held Items
static const u8 sLightBallDesc[] = _(
    "A hold item that\n"
    "raises the Atk and\n"
    "Sp. Atk of Pikachu.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLeekDesc[] = _(
    "A hold item that\n"
    "raises Farfetch'd's\n"
    "critical-hit ratio.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sThickClubDesc[] = _(
    "A hold item that \n"
    "raises Cubone or\n"
    "Marowak's Attack.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLuckyPunchDesc[] = _(
    "A hold item that\n"
    "raises Chansey's\n"
    "critical-hit rate.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMetalPowderDesc[] = _(
    "A hold item that\n"
    "raises Ditto's\n"
    "Defense.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sQuickPowderDesc[] = _(
    "An item to be held\n"
    "by Ditto. This odd\n"
    "powder boosts Speed.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDeepSeaScaleDesc[] = _(
    "A hold item that\n"
    "raises the Sp. Def\n"
    "of Clamperl.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sSoulDewDesc[] = _(
    ...
    "Hold item: raises\n"
    "Sp. Atk & Sp. Def of\n"
    "Latios & Latias.{COLOR RED}{SHADOW LIGHT_RED}");
#endif
...
static const u8 sLaxIncenseDesc[] = _(
    "A hold item that\n"
    "slightly lowers the\n"
    "foe's accuracy.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFullIncenseDesc[] = _(
    "A held item that\n"
    "makes the holder\n"
    "move slower.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sLuckIncenseDesc[] = _(
    "Doubles money in\n"
    "battle if the\n"
    "holder takes part.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRedScarfDesc[] = _(
    "A hold item that\n"
    "raises Cool in\n"
    "Contests.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sMachoBraceDesc[] = _(
    "A hold item that\n"
    "promotes growth,\n"
    "but reduces Speed.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sSilkScarfDesc[] = _(
    "A hold item that\n"
    "raises the power of\n"
    "Normal-type moves.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sChoiceBandDesc[] = _(
    "Raises a move's\n"
    "power, but permits\n"
    "only that move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sChoiceSpecsDesc[] = _(
    "Boosts Sp. Atk, but\n"
    "allows the use of\n"
    "only one move.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFlameOrbDesc[] = _(
    "A bizarre orb that\n"
    "inflicts a burn on\n"
    "holder in battle.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sDampRockDesc[] = _(
    "Extends the length\n"
    "of Rain Dance if\n"
    "used by the holder.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sElectricSeedDesc[] = _(
    "Boosts Defense on\n"
    "Electric Terrain,\n"
    "but only one time.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sAbsorbBulbDesc[] = _(
    ...
    "a Water-type move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sCellBatteryDesc[] = _(
    "Raises Atk if the\n"
    "holder is hit by an\n"
    "Electric-type move.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sSnowballDesc[] = _(
    "Raises Atk if its\n"
    "holder is hit by an\n"
    "Ice-type move.{COLOR RED}{SHADOW LIGHT_RED}");

// Misc. Held Items
static const u8 sBrightPowderDesc[] = _(
    "A hold item that\n"
    "casts a glare to\n"
    "reduce accuracy.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sQuickClawDesc[] = _(
    "A hold item that\n"
    "occasionally allows\n"
    "the first strike.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSootheBellDesc[] = _(
    "A hold item that\n"
    "calms spirits and\n"
    "fosters friendship.{COLOR RED}{SHADOW LIGHT_RED}");

#if B_MENTAL_HERB >= GEN_5
static const u8 sMentalHerbDesc[] = _(
    "Snaps Pokémon out\n"
    "of move-binding\n"
    "effects.{COLOR RED}{SHADOW LIGHT_RED}");
#else
static const u8 sMentalHerbDesc[] = _(
    "A hold item that\n"
    "snaps Pokémon out\n"
    "of infatuation.{COLOR RED}{SHADOW LIGHT_RED}");
#endif

static const u8 sKingsRockDesc[] = _(
    "A hold item that\n"
    "may cause flinching\n"
    "when the foe is hit.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sSmokeBallDesc[] = _(
    "A hold item that\n"
    "assures fleeing\n"
    "from wild Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sFocusBandDesc[] = _(
    "A hold item that\n"
    "occasionally\n"
    "prevents fainting.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLuckyEggDesc[] = _(
    "A hold item that\n"
    "boosts Exp. points\n"
    "earned in battle.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sLeftoversDesc[] = _(
    "A hold item that\n"
    "gradually restores\n"
    "HP in battle.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sShellBellDesc[] = _(
    "A hold item that\n"
    "restores HP upon\n"
    "striking the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWideLensDesc[] = _(
    "A magnifying lens\n"
    "that boosts the\n"
    "accuracy of moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMuscleBandDesc[] = _(
    "A headband that\n"
    "boosts the power of\n"
    "physical moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWiseGlassesDesc[] = _(
    "A pair of glasses\n"
    "that ups the power\n"
    "of special moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sExpertBeltDesc[] = _(
    "A belt that boosts\n"
    "the power of super\n"
    "effective moves.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sLifeOrbDesc[] = _(
    "Boosts the power of\n"
    "moves at the cost\n"
    "of some HP per turn.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPowerHerbDesc[] = _(
    "Allows immediate\n"
    "use of a move that\n"
    "charges first.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sFocusSashDesc[] = _(
    "If the holder has\n"
    "full HP, it endures\n"
    "KO hits with 1 HP.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sZoomLensDesc[] = _(
    "If the holder moves\n"
    "after the foe, it'll\n"
    "boost accuracy.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMetronomeDesc[] = _(
    "A held item that\n"
    "boosts a move used\n"
    "consecutively.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sIronBallDesc[] = _(
    "Cuts Speed and lets\n"
    "Flying-types be hit\n"
    "by Ground moves.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sDestinyKnotDesc[] = _(
    "If the holder falls\n"
    "in love, the foe\n"
    "does too.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBlackSludgeDesc[] = _(
    "Gradually restores\n"
    "HP of Poison-types.\n"
    "Damages others.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGripClawDesc[] = _(
    "Makes binding moves\n"
    "used by the holder\n"
    "go on for 7 turns.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sStickyBarbDesc[] = _(
    "Damages the holder\n"
    "each turn. May latch\n"
    "on to foes.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sShedShellDesc[] = _(
    "Enables the holder\n"
    "to switch out of\n"
    "battle without fail.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBigRootDesc[] = _(
    "A held item that\n"
    "boosts the power of\n"
    "HP-stealing moves.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sEvioliteDesc[] = _(
    "Raises the Def and\n"
    "Sp. Def of Pokémon\n"
    "that can evolve.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sFloatStoneDesc[] = _(
    "It's so light that\n"
    "when held, it halves\n"
    "a Pokémon's weight.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRockyHelmetDesc[] = _(
    "Hurts the foe if\n"
    "they touch its\n"
    "holder.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAirBalloonDesc[] = _(
    "Elevates the holder\n"
    "in the air. If hit,\n"
    "this item will burst.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRingTargetDesc[] = _(
    "Moves that wouldn't\n"
    "have effect will\n"
    "land on its holder.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBindingBandDesc[] = _(
    "Increases the\n"
    "power of binding\n"
    "moves when held.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sEjectButtonDesc[] = _(
    "Switches out the\n"
    "user if they're hit\n"
    "by the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWeaknessPolicyDesc[] = _(
    "If hit by a Super\n"
    "Effective move, ups\n"
    "Atk and Sp. Atk.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAssaultVestDesc[] = _(
    "Raises Sp. Def but\n"
    "prevents the use\n"
    "of status moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSafetyGogglesDesc[] = _(
    "Protect from\n"
    "weather damage and\n"
    "powder moves.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sTerrainExtenderDesc[] = _(
    "Extends the length\n"
    "of the active\n"
    "battle terrain.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sThroatSprayDesc[] = _(
    "Raises Sp. Atk. if\n"
    "the holder uses a\n"
    "sound-based move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sEjectPackDesc[] = _(
    "Forces the user to\n"
    "switch if its stats\n"
    "are lowered.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sHeavyDutyBootsDesc[] = _(
    "Boots that prevent\n"
    "effects of traps\n"
    "set in the field.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBlunderPolicyDesc[] = _(
    "Raises Speed if\n"
    "the user misses\n"
    "due to Accuracy.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRoomServiceDesc[] = _(
    "Lowers Speed if\n"
    "Trick Room is\n"
    "active.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sUtilityUmbrellaDesc[] = _(
    "An umbrella that\n"
    "protects from\n"
    "weather effects.{COLOR RED}{SHADOW LIGHT_RED}");

// Berries
static const u8 sCheriBerryDesc[] = _(
    "A hold item that\n"
    "heals paralysis\n"
    "in battle.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sLumBerryDesc[] = _(
    "A hold item that\n"
    "heals any status\n"
    "problem in battle.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSitrusBerryDesc[] = _(
#if I_SITRUS_BERRY_HEAL >= GEN_4
    "A hold item that\n"
    "restores the user's\n"
    "HP a little.{COLOR RED}{SHADOW LIGHT_RED}");
#else
    "A hold item that\n"
    "restores 30 HP in\n"
    "battle.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFigyBerryDesc[] = _(
    "A hold item that\n"
    "restores HP but\n"
    "may confuse.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRazzBerryDesc[] = _(
    ...
    "Plant in loamy soil\n"
    "to grow Razz.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBlukBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Bluk.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sNanabBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Nanab.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWepearBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Wepear.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPinapBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Pinap.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPomegBerryDesc[] = _(
    "Makes a Pokémon\n"
    "friendly but lowers\n"
    "base HP.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sKelpsyBerryDesc[] = _(
    "Makes a Pokémon\n"
    "friendly but lowers\n"
    "base Attack.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sQualotBerryDesc[] = _(
    "Makes a Pokémon\n"
    "friendly but lowers\n"
    "base Defense.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sHondewBerryDesc[] = _(
    "Makes a Pokémon\n"
    "friendly but lowers\n"
    "base Sp. Atk.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGrepaBerryDesc[] = _(
    "Makes a Pokémon\n"
    "friendly but lowers\n"
    "base Sp. Def.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTamatoBerryDesc[] = _(
    "Makes a Pokémon\n"
    "friendly but lowers\n"
    "base Speed.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sCornnBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Cornn.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMagostBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Magost.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRabutaBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Rabuta.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sNomelBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Nomel.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSpelonBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Spelon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPamtreBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Pamtre.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWatmelBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Watmel.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDurinBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Durin.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBelueBerryDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow Belue.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sOccaBerryDesc[] = _(
    "A hold item that\n"
    "weakens a Fire\n"
    "move if weak to it.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sLiechiBerryDesc[] = _(
    "A hold item that\n"
    "raises Attack in\n"
    "a pinch.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sLansatBerryDesc[] = _(
    "A hold item that\n"
    "ups the critical-\n"
    "hit rate in a pinch.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sStarfBerryDesc[] = _(
    "A hold item that\n"
    "sharply boosts a\n"
    "stat in a pinch.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sMicleBerryDesc[] = _(
    "When held, it ups\n"
    "the Accuracy of a\n"
    "move in a pinch.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sCustapBerryDesc[] = _(
    "It allows a Pokémon\n"
    "in a pinch to move\n"
    "first just once.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sJabocaBerryDesc[] = _(
    "If hit by a physical\n"
    "move, it will hurt\n"
    "the attacker a bit.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sKeeBerryDesc[] = _(
    "If hit by a physical\n"
    "move, it raises the\n"
    "Defense a bit.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMarangaBerryDesc[] = _(
    "If hit by a special\n"
    "move, it raises the\n"
    "Sp. Def. a bit.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sEnigmaBerryEReaderDesc[] = _(
    "{POKEBLOCK} ingredient.\n"
    "Plant in loamy soil\n"
    "to grow a mystery.{COLOR RED}{SHADOW LIGHT_RED}");

// TMs/HMs
static const u8 sTM01Desc[] = _(
    "Powerful, but makes\n"
    "the user flinch if\n"
    "hit by the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM02Desc[] = _(
    "Hooks and slashes\n"
    "the foe with long,\n"
    "sharp claws.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM03Desc[] = _(
    "Generates an\n"
    "ultrasonic wave\n"
    "that may confuse.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM04Desc[] = _(
    "Raises Sp. Atk and\n"
    "Sp. Def by focusing\n"
    "the mind.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM05Desc[] = _(
    "A savage roar that\n"
    "makes the foe flee \n"
    "to end the battle.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM06Desc[] = _(
    "Poisons the foe\n"
    "with a toxin that\n"
    "gradually worsens.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM07Desc[] = _(
    "Creates a hailstorm\n"
    "that damages all\n"
    "types except Ice.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM08Desc[] = _(
    "Bulks up the body\n"
    "to boost both\n"
    "Attack & Defense.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM09Desc[] = _(
    "Shoots 2 to 5 seeds\n"
    "in a row to strike\n"
    "the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM10Desc[] = _(
    "The attack power\n"
    "varies among\n"
    "different Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM11Desc[] = _(
    "Raises the power of\n"
    "Fire-type moves\n"
    "for 5 turns.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM12Desc[] = _(
    "Enrages the foe so\n"
    "it can only use\n"
    "attack moves.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM13Desc[] = _(
    "Fires an icy cold\n"
    "beam that may\n"
    "freeze the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM14Desc[] = _(
    "A brutal snow-and-\n"
    "wind attack that\n"
    "may freeze the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM15Desc[] = _(
    "Powerful, but needs\n"
    "recharging the\n"
    "next turn.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM16Desc[] = _(
    "Creates a wall of\n"
    "light that lowers\n"
    "Sp. Atk damage.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM17Desc[] = _(
    "Negates all damage,\n"
    "but may fail if used\n"
    "in succession.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sTM19Desc[] = _(
    "Recovers half the\n"
    "HP of the damage \n"
    "this move inflicts.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM20Desc[] = _(
    "Prevents status\n"
    "abnormality with a\n"
    "mystical power.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM21Desc[] = _(
    "The less the user\n"
    "likes you, the more\n"
    "powerful this move.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM22Desc[] = _(
    "Absorbs sunlight in\n"
    "the 1st turn, then\n"
    "attacks next turn.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM23Desc[] = _(
    "Slams the foe with\n"
    "a hard tail. It may\n"
    "lower Defense.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM24Desc[] = _(
    "A powerful electric\n"
    "attack that may\n"
    "cause paralysis.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM25Desc[] = _(
    "Strikes the foe\n"
    "with a thunderbolt.\n"
    "It may paralyze.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM26Desc[] = _(
    "Causes a quake\n"
    "that has no effect\n"
    "on flying foes.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sTM28Desc[] = _(
    "Digs underground\n"
    "the 1st turn, then\n"
    "strikes next turn.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM29Desc[] = _(
    "A powerful psychic\n"
    "attack that may\n"
    "lower Sp. Def.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sTM31Desc[] = _(
    "Destroys barriers\n"
    "like Light Screen\n"
    "and causes damage.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM32Desc[] = _(
    "Creates illusory\n"
    "copies to enhance\n"
    "elusiveness.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM33Desc[] = _(
    "Creates a wall of\n"
    "light that weakens\n"
    "physical attacks.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM34Desc[] = _(
    "Zaps the foe with a\n"
    "jolt of electricity\n"
    "that never misses.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sTM37Desc[] = _(
    "Causes a sandstorm\n"
    "that hits the foe\n"
    "over several turns.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM38Desc[] = _(
    "A powerful fire\n"
    "attack that may\n"
    "burn the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM39Desc[] = _(
    "Stops the foe from\n"
    "moving with rocks.\n"
    "May lower Speed.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM40Desc[] = _(
    "An extremely fast\n"
    "attack that can't\n"
    "be avoided.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM41Desc[] = _(
    "Prevents the foe\n"
    "from using the same\n"
    "move in a row.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM42Desc[] = _(
    "Raises Attack when\n"
    "poisoned, burned,\n"
    "or paralyzed.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM43Desc[] = _(
    "Adds an effect to\n"
    "attack depending\n"
    "on the location.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM44Desc[] = _(
    "The user sleeps for\n"
    "2 turns to restore\n"
    "health and status.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sTM46Desc[] = _(
    "While attacking,\n"
    "it may steal the\n"
    "foe's held item.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM47Desc[] = _(
    "Spreads hard-\n"
    "edged wings and\n"
    "slams into the foe.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM48Desc[] = _(
    "Switches abilities\n"
    "with the foe on the\n"
    "turn this is used.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM49Desc[] = _(
    "Steals the effects\n"
    "of the move the foe\n"
    "is trying to use.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTM50Desc[] = _(
    "Enables full-power\n"
    "attack, but sharply\n"
    "lowers Sp. Atk.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sHM01Desc[] = _(
    "Attacks the foe\n"
    "with sharp blades\n"
    "or claws.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sHM03Desc[] = _(
    "Creates a huge\n"
    "wave, then crashes\n"
    "it down on the foe.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sHM05Desc[] = _(
    "Looses a powerful\n"
    "blast of light that\n"
    "reduces accuracy.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sHM06Desc[] = _(
    "A rock-crushingly\n"
    "tough attack that\n"
    "may lower Defense.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sHM07Desc[] = _(
    "Attacks the foe\n"
    "with enough power\n"
    "to climb waterfalls.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sOvalCharmDesc[] = _(
    "Raises the chance\n"
    "of finding eggs\n"
    "at the daycare.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sShinyCharmDesc[] = _(
    "A charm that will\n"
    "raise the chance\n"
    "of Shiny Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sCatchingCharmDesc[] = _(
    "A charm that raises\n"
    "the chance of\n"
    "Critical Captures.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sRotomCatalogDesc[] = _(
    "A catalog full of\n"
    "deviced liked by\n"
    "Rotom.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGracideaDesc[] = _(
    "Bouquets made with\n"
    "it are offered as a\n"
    "token of gratitude.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRevealGlassDesc[] = _(
    "This glass returns\n"
    "a Pokémon back to\n"
    "its original form.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDNASplicersDesc[] = _(
    "Splicer that fuses\n"
    "Kyurem and a\n"
    "certain Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sZygardeCubeDesc[] = _(
    "An item to store\n"
    "Zygarde Cores and\n"
    "Cells.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPrisonBottleDesc[] = _(
    "A bottle used to\n"
    "seal a certain\n"
    "Pokémon long ago.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sNSolarizerDesc[] = _(
    "A device to fuse\n"
    "and split Necrozma\n"
    "using a Solgaleo.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sNLunarizerDesc[] = _(
    "A device to fuse\n"
    "and split Necrozma\n"
    "using a Lunala.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sReinsOfUnityDesc[] = _(
    "Reins that unite\n"
    "Calyrex with its\n"
    "beloved steed.{COLOR RED}{SHADOW LIGHT_RED}");

// Battle Mechanic Key Items
static const u8 sMegaRingDesc[] = _(
    "Enables {PKMN} holding\n"
    "their Mega Stone to\n"
    "Mega Evolve.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sZPowerRingDesc[] = _(
    "A strange ring\n"
    "that enables\n"
    "Z-Move usage.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDynamaxBandDesc[] = _(
    "A band carrying a\n"
    "Wishing Star that\n"
    "allows Dynamaxing.{COLOR RED}{SHADOW LIGHT_RED}");

// Misc. Key Items
static const u8 sBicycleDesc[] = _(
    "A folding bicycle\n"
    "that is faster than\n"
    "the Running Shoes.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMachBikeDesc[] = _(
    "A folding bicycle\n"
    "that doubles your\n"
    "speed or better.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAcroBikeDesc[] = _(
    "A folding bicycle\n"
    "capable of jumps\n"
    "and wheelies.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sOldRodDesc[] = _(
    "Use by any body of\n"
    "water to fish for\n"
    "wild Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sDowsingMachineDesc[] = _(
    ...
    "item by sound.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTownMapDesc[] = _(
    "Can be viewed\n"
    "anytime. Shows your\n"
    "present location.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sVsSeekerDesc[] = _(
    "A rechargeable unit\n"
    "that flags battle-\n"
    "ready Trainers.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTMCaseDesc[] = _(
    "A convenient case \n"
    "that holds TMs and\n"
    "HMs.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBerryPouchDesc[] = _(
    "A convenient\n"
    "container that\n"
    "holds Berries.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPokemonBoxLinkDesc[] = _(
    "This device grants\n"
    "access to the {PKMN}\n"
    "Storage System.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sCoinCaseDesc[] = _(
    "A case that holds\n"
    "up to 9,999 Coins.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPowderJarDesc[] = _(
    "Stores Berry\n"
    "Powder made using\n"
    "a Berry Crusher.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sWailmerPailDesc[] = _(
    "A tool used for\n"
    "watering Berries\n"
    "and plants.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPokeRadarDesc[] = _(
    "A tool used to\n"
    "search out Pokémon\n"
    "hiding in grass.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPokeblockCaseDesc[] = _(
    "A case for holding\n"
    "{POKEBLOCK}s made with\n"
    "a Berry Blender.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSootSackDesc[] = _(
    "A sack used to\n"
    "gather and hold\n"
    "volcanic ash.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sFameCheckerDesc[] = _(
    "Stores information\n"
    "on famous people\n"
    "for instant recall.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTeachyTVDesc[] = _(
    "A TV set tuned to\n"
    "an advice program\n"
    "for Trainers.{COLOR RED}{SHADOW LIGHT_RED}");

// Story Key Items
static const u8 sSSTicketDesc[] = _(
    "The ticket required\n"
    "for sailing on a\n"
    "ferry.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sEonTicketDesc[] = _(
    "The ticket for a\n"
    "ferry to a distant\n"
    "southern island.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMysticTicketDesc[] = _(
    "A ticket required\n"
    "to board the ship\n"
    "to Navel Rock.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAuroraTicketDesc[] = _(
    "A ticket required\n"
    "to board the ship\n"
    "to Birth Island.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sOldSeaMapDesc[] = _(
    "A faded sea chart\n"
    "that shows the way\n"
    "to a certain island.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLetterDesc[] = _(
    "A letter to Steven\n"
    "from the President\n"
    "of the Devon Corp.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDevonPartsDesc[] = _(
    "A package that\n"
    "contains Devon's\n"
    "machine parts.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGoGogglesDesc[] = _(
    "Nifty goggles that\n"
    "protect eyes from\n"
    "desert sandstorms.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sDevonScopeDesc[] = _(
    "A device by Devon\n"
    "that signals any\n"
    "unseeable Pokémon.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBasementKeyDesc[] = _(
    "The key for New\n"
    "Mauville beneath\n"
    "Mauville City.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sScannerDesc[] = _(
    "A device found\n"
    "inside the\n"
    "Abandoned Ship.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sMeteoriteDesc[] = _(
    "A meteorite found\n"
    "at Meteor Falls.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sMagmaEmblemDesc[] = _(
    "A medal-like item in\n"
    "the same shape as\n"
    "Team Magma's mark.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sContestPassDesc[] = _(
    "The pass required\n"
    "for entering\n"
    "Pokémon Contests.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sParcelDesc[] = _(
    "A parcel for Prof.\n"
    "Oak from a Pokémon\n"
    "Mart's clerk.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSecretKeyDesc[] = _(
    "The key to the\n"
    "Cinnabar Island\n"
    "Gym's entrance.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBikeVoucherDesc[] = _(
    "A voucher for\n"
    "obtaining a bicycle\n"
    "from the Bike Shop.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGoldTeethDesc[] = _(
    "Gold dentures lost\n"
    "by the Safari\n"
    "Zone's Warden.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sCardKeyDesc[] = _(
    "A card-type door\n"
    "key used in Silph\n"
    "Co's office.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLiftKeyDesc[] = _(
    "An elevator key\n"
    "used in Team\n"
    "Rocket's Hideout.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSilphScopeDesc[] = _(
    "Silph Co's scope\n"
    "makes unseeable\n"
    "POKéMON visible.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTriPassDesc[] = _(
    "A pass for ferries\n"
    "between One, Two,\n"
    "and Three Island.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRainbowPassDesc[] = _(
    "For ferries serving\n"
    "Vermilion and the\n"
    "Sevii Islands.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTeaDesc[] = _(
    "A thirst-quenching\n"
    "tea prepared by an\n"
    "old lady.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sRubyDesc[] = _(
    "An exquisite, red-\n"
    "glowing gem that\n"
    "symbolizes passion.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sSapphireDesc[] = _(
    "A brilliant blue gem\n"
    "that symbolizes\n"
    "honesty.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAbilityShieldDesc[] = _(
    "Ability changes are\n"
    "prevented for this\n"
    "items's holder.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sPunchingGloveDesc[] = _(
    "Powers up punching\n"
    "moves and removes\n"
    "their contact.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sCovertCloakDesc[] = _(
    "Protects the holder\n"
    "from secondary\n"
    "move effects.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLoadedDiceDesc[] = _(
    "Rolls high numbers.\n"
    "Multihit strikes\n"
    "hit more times.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sPokePassDesc[] = _(
    "Grants access to\n"
    "Pokémon Centres\n"
    "and Battle Clubs.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAuspiciousArmorDesc[] = _(
    "Armor inhabited by\n"
    "auspicious wishes.\n"
    "Causes evolution.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBoosterEnergyDesc[] = _(
    "Encapsuled energy\n"
    "ups Pokémon with\n"
    "certain Abilities.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sBigBambooShootDesc[] = _(
    "A large and rare\n"
    "bamboo shoot. Best\n"
    "sold to gourmands.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sGimmighoulCoinDesc[] = _(
    "Gimmighoul hoard\n"
    "and treasure these\n"
    "curious coins.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sLeadersCrestDesc[] = _(
    "A shard of an old\n"
    "blade of some sort.\n"
    "Held by Bisharp.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sMirrorHerbDesc[] = _(
    "Mirrors an enemy's\n"
    "stat increases\n"
    "but only once.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sScrollOfDarknessDesc[] = _(
    "A peculiar scroll\n"
    "with secrets of\n"
    "the dark path.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sScrollOfWatersDesc[] = _(
    "A peculiar scroll\n"
    "with secrets of\n"
    "the water path.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sTeraOrbDesc[] = _(
    "Energy charges can\n"
    "be used to cause\n"
    "Terastallization.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sTeraShardDesc[] = _(
    "These shards may\n"
    "form when a Tera\n"
    "Pokémon faints.{COLOR RED}{SHADOW LIGHT_RED}");

static const u8 sAdamantCrystalDesc[] = _(
    "A large, glowing gem\n"
    "that lets Dialga\n"
    "change form.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sBerserkGene[] = _(
    "Sharply boosts\n"
    "Attack, but causes\n"
    "lasting confusion.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sCornerstoneMaskDesc[] = _(
    "Allows Ogerpon to\n"
    "wield the Rock-\n"
    "type in battle.{COLOR RED}{SHADOW LIGHT_RED}");
...
static const u8 sGlimmeringCharmDesc[] = _(
    "A charm that will\n"
    "raise the shards\n"
    "from Tera Raids.{COLOR RED}{SHADOW LIGHT_RED}");
