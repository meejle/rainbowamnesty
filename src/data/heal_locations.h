static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RA_PLAYERSHOUSE_1F - 1] = {MAP_GROUP(RA_MISTRALTON_PLAYERS_HOUSE_1F), MAP_NUM(RA_MISTRALTON_PLAYERS_HOUSE_1F), 4, 5},
    [HEAL_LOCATION_RA_MISTRALTON - 1] = {MAP_GROUP(RA_MISTRALTON), MAP_NUM(RA_MISTRALTON), 55, 56},
};
