...
static void Task_DoClearSaveDataScreenYesNo(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, FONT_NORMAL_SUBPIXEL, gText_ClearAllSaveData, 0, 1, 0, 0);
...
static void Task_ClearSaveDataScreenYesNoChoice(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(0, FONT_NORMAL_SUBPIXEL, gText_ClearingData, 0, 1, 0, 0);
