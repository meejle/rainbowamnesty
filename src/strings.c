...
const u8 gText_ExpandedPlaceholder_Kun[] = _(""); // Fallback
const u8 gText_ExpandedPlaceholder_Chan[] = _(""); // Fallback
...
const u8 gText_MainMenuMysteryGift[] = _(""); // Fallback
const u8 gText_MainMenuMysteryGift2[] = _(""); // Fallback
const u8 gText_MainMenuMysteryEvents[] = _(""); // Fallback
const u8 gText_WirelessNotConnected[] = _(""); // Fallback
const u8 gText_MysteryGiftCantUse[] = _(""); // Fallback
const u8 gText_MysteryEventsCantUse[] = _(""); // Fallback
...
const u8 gJPText_No1MSubCircuit[] = _(""); // Fallback
