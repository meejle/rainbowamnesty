...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Avery");
const u8 gText_ExpandedPlaceholder_May[] = _("Beth");
const u8 gText_EggNickname[] = _("Egg");
const u8 gText_Pokemon[] = _("Pokémon");
const u8 gText_ProfBirchMatchCallName[] = _("Prof. Magnolia");
const u8 gText_MainMenuNewGame[] = _(" Start a new adventure");
const u8 gText_MainMenuContinue[] = _(" Continuexyourzadventurf"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank0[] = _("D"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank1[] = _("E"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank2[] = _("F"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank3[] = _("G"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank4[] = _("H"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank5[] = _("I"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank6[] = _("J"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank7[] = _("K"); // Yes, this is super janky
const u8 gText_MainMenuContinue_Rank8[] = _("L"); // Yes, this is super janky
const u8 gText_MainMenuOption[] = _(" Change options");
const u8 gText_SaveFileCorrupted[] = _(" Your save data is corrupted. Your\n previous save will be loaded instead.");
const u8 gText_SaveFileErased[] = _(" Sorry, but your save data had to be\n deleted due to corruption or damage.");
const u8 gText_BatteryRunDry[] = _(" The game thinks your {COLOR RED}{SHADOW LIGHT_RED}GBA{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY} cartridge's\n internal battery has run dry.\p > This usually means your emulator isn't\n set up correctly.\p > You can still play the game, but\n clock-based events won't take place.");
...
const u8 gText_BirchInTrouble[] = _(" Which Pokémon will you take with\n you on your mission?");
const u8 gText_ConfirmStarterChoice[] = _(" Will you choose this Pokémon?");
...
const u8 gText_ItemsPocket[] = _("{FONT_SHORT}Items");
const u8 gText_PokeBallsPocket[] = _("{FONT_SHORT}Poké Balls");
const u8 gText_TMHMPocket[] = _("{FONT_SHORT}TMs & HMs");
const u8 gText_BerriesPocket[] = _("{FONT_SHORT}Berries");
const u8 gText_KeyItemsPocket[] = _("{FONT_SHORT}Key Items");
...
const u8 gText_MenuOptionPokenav[] = _("Poryphone");
...
const u8 gText_SaveFailedCheckingBackup[] = _("Save failed. Checking your save data...\nThis might take a minute or two.\nDon't close the emulator.");
const u8 gText_BackupMemoryDamaged[] = _("Save failed. Try changing your emulator\nsettings, or using a more modern\nemulator. Press {FONT 14}V{FONT 11} to restart the game.");
const u8 gText_GamePlayCannotBeContinued[] = _("Sorry... We ran into a serious problem\nand weren't able to continue the game.\nPress {FONT 14}V{FONT 11} to restart.");
const u8 gText_CheckCompleted[] = _("Checks completed.\nTrying to save again...\nDon't close the\nemulator.");
const u8 gText_SaveCompleteGameCannotContinue[] = _("Saved successfully!\nBut, we couldn't resume the game.\nPress {FONT 14}V{FONT 11} to restart.");
const u8 gText_SaveCompletePressA[] = _("Saved successfully!\nPress {FONT 14}V{FONT 11} to continue.");
const u8 gText_Ferry[] = _("FERRY");
const u8 gText_SecretBase[] = _("SECRET BASE");
const u8 gText_Hideout[] = _("HIDEOUT");
const u8 gText_ResetRTCConfirmCancel[] = _("Do you need to set the in-game clock?\n{FONT 14}V{FONT 11} Set   {FONT 14}W{FONT 11} Don't set");
const u8 gText_PresentTime[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE} Current in-game time:");
const u8 gText_PreviousTime[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE} In-game time at last save:");
const u8 gText_PleaseResetTime[] = _("Use {FONT 14}Z{FONT 11} to set the correct time.");
const u8 gText_ClockHasBeenReset[] = _("The clock has been set.\nSaving... Don't close the emulator.");
const u8 gText_SaveCompleted[] = _("Your {COLOR RED}{SHADOW LIGHT_RED}Mission Log{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY} is now up to date.");
const u8 gText_SaveFailed[] = _("Your adventure couldn't be saved. Your\nemulator might not be set up correctly.");
...
const u8 gText_TrainerCardName[] = _("Name: {COLOR GREEN}{SHADOW LIGHT_GREEN}");
...
const u8 gText_Var1sTrainerCard[] = _("{PLAYER}'s Poké Pass");
...
const u8 gText_ContinueMenuTime[] = _("Play time:");
const u8 gText_ContinueMenuPokedex[] = _(" Pokédex:");
const u8 gText_ContinueMenuBadges[] = _("Rank:");
...
const u8 gText_Option[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Change options\n{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}{FONT 14}b{FONT 10} Select   {FONT 14}c{FONT 10} Toggle on/off   {FONT 14}W{FONT 10} Confirm");
const u8 gText_TextSpeed[] = _("Text speed");
const u8 gText_BattleScene[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Show animations in battles");
const u8 gText_BattleStyle[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Switch before opponent's next Pokémon");
const u8 gText_Sound[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Confirm before overwriting save data");
const u8 gText_OptionMenuCancel[] = _("{COLOR RED}{SHADOW LIGHT_RED}Exit");
...
const u8 gText_OptionMenuOn[] = _("{HIGHLIGHT WHITE}{COLOR GREEN}{SHADOW LIGHT_GREEN}{FONT 14}♂");
const u8 gText_OptionMenuOff[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}{FONT 14}¥");
const u8 gText_SaveRemind[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Show reminders to save at key moments");
const u8 gText_TxExp[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Explain obscure moves and Abilities");
...
const u8 gText_Days[] = _("   Day ");
const u8 gText_MenuPokedex[] = _("{COLOR RED}{SHADOW LIGHT_RED}Pokédex");
const u8 gText_MenuPokemon[] = _("Pokémon");
const u8 gText_MenuBag[] = _("Bag");
const u8 gText_MenuPokenav[] = _("{COLOR RED}{SHADOW LIGHT_RED}Poryphone");
const u8 gText_MenuPlayer[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{PLAYER}");
...
const u8 gText_Defense[] = _("Defence");
...
const u8 gText_SavingPlayer[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Player:");
const u8 gText_SavingBadges[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Rank:");
const u8 gText_SavingPokedex[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Pokédex:");
const u8 gText_SavingTime[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Play time:");
const u8 gText_SavingPlayerName[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{PLAYER}");
const u8 gText_SavingPlaceName[] = _("{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_3}");
...
// Most custom strings for Rainbow Amnesty are below

const u8 gText_Rank0[] = _("{COLOR RED}{SHADOW LIGHT_RED}Trainee{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank1[] = _("{COLOR RED}{SHADOW LIGHT_RED}Recruit{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank2[] = _("{COLOR RED}{SHADOW LIGHT_RED}Officer{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank3[] = _("{COLOR RED}{SHADOW LIGHT_RED}Sergeant{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank4[] = _("{COLOR RED}{SHADOW LIGHT_RED}Detective{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank5[] = _("{COLOR RED}{SHADOW LIGHT_RED}Lieutenant{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank6[] = _("{COLOR RED}{SHADOW LIGHT_RED}Captain{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank7[] = _("{COLOR RED}{SHADOW LIGHT_RED}Commander{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_Rank8[] = _("{COLOR RED}{SHADOW LIGHT_RED}Chief{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}");
const u8 gText_White_Rank0[] = _("Trainee");
const u8 gText_White_Rank1[] = _("Recruit");
const u8 gText_White_Rank2[] = _("Officer");
const u8 gText_White_Rank3[] = _("Sergeant");
const u8 gText_White_Rank4[] = _("Detective");
const u8 gText_White_Rank5[] = _("Lieutenant");
const u8 gText_White_Rank6[] = _("Captain");
const u8 gText_White_Rank7[] = _("Commander");
const u8 gText_White_Rank8[] = _("Chief");

const u8 gText_Perks0[] = _("{PKMN} Centre ONLY");
const u8 gText_Perks1[] = _("{PKMN} Centre");
const u8 gText_Perks2[] = _("Battle Club");
const u8 gText_Perks3[] = _("Research Hub");
const u8 gText_Perks4[] = _("{PKMN} League");

const u8 gText_RA_Goal_Title[] = _("{COLOR RED}{SHADOW LIGHT_RED}NOPQ");
const u8 gText_RA_Goal_1_Line_1[] = _("Become a member of the");
const u8 gText_RA_Goal_1_Line_2[] = _("{COLOR RED}{SHADOW LIGHT_RED}Amnesty Institute{SHADOW LIGHT_GRAY}{COLOR DARK_GRAY}!");


// Dummied out strings, currently left in as fallback

const u8 gText_CommStandbyAwaitingOtherPlayer[] = _("");
const u8 gText_BattleWasRefused[] = _("");
const u8 gText_RefusedBattle[] = _("");
const u8 gText_MrStoneMatchCallDesc[] = _("");
const u8 gText_MrStoneMatchCallName[] = _("");
const u8 gText_StevenMatchCallDesc[] = _("");
const u8 gText_StevenMatchCallName[] = _("");
const u8 gText_MayBrendanMatchCallDesc[] = _("");
const u8 gText_NormanMatchCallDesc[] = _("");
const u8 gText_MomMatchCallDesc[] = _("");
const u8 gText_WallyMatchCallDesc[] = _("");
const u8 gText_NormanMatchCallName[] = _("");
const u8 gText_MomMatchCallName[] = _("");
const u8 gText_ScottMatchCallDesc[] = _("");
const u8 gText_ScottMatchCallName[] = _("");
const u8 gText_RoxanneMatchCallDesc[] = _("");
const u8 gText_BrawlyMatchCallDesc[] = _("");
const u8 gText_WattsonMatchCallDesc[] = _("");
const u8 gText_FlanneryMatchCallDesc[] = _("");
const u8 gText_WinonaMatchCallDesc[] = _("");
const u8 gText_TateLizaMatchCallDesc[] = _("");
const u8 gText_JuanMatchCallDesc[] = _("");
const u8 gText_EliteFourMatchCallDesc[] = _("");
const u8 gText_ChampionMatchCallDesc[] = _("");
const u8 gText_ProfBirchMatchCallDesc[] = _("");
const u8 gText_Kira[] = _("");
const u8 gText_Amy[] = _("");
const u8 gText_John[] = _("");
const u8 gText_Roy[] = _("");
const u8 gText_Gabby[] = _("");
const u8 gText_Anna[] = _("");
const u8 gText_ExpandedPlaceholder_Kun[] = _("");
const u8 gText_ExpandedPlaceholder_Chan[] = _("");
const u8 gText_MainMenuMysteryGift[] = _("");
const u8 gText_MainMenuMysteryGift2[] = _("");
const u8 gText_MainMenuMysteryEvents[] = _("");
const u8 gText_WirelessNotConnected[] = _("");
const u8 gText_MysteryGiftCantUse[] = _("");
const u8 gText_MysteryEventsCantUse[] = _("");
const u8 gJPText_No1MSubCircuit[] = _("");
