...
const u8 gText_PresentTime[] = _("{COLOR BLUE} Current in-game time:");
const u8 gText_PreviousTime[] = _("{COLOR BLUE} In-game time at last save:");
...
const u8 gText_SaveCompleted[] = _("> Your {COLOR RED}Mission Log{COLOR DARK_GRAY} is now up to date.");
...
const u8 gText_TrainerCardName[] = _("Name: {COLOR GREEN}");
...
const u8 gText_Option[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Change options\n{COLOR DARK_GRAY}{FONT 14}b{FONT 10} Select   {FONT 14}c{FONT 10} Toggle on/off   {FONT 14}W{FONT 10} Confirm");
const u8 gText_TextSpeed[] = _("Text speed");
const u8 gText_BattleScene[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Show animations in battles");
const u8 gText_BattleStyle[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Switch before opponent's next Pokémon");
const u8 gText_Sound[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Confirm before overwriting save data");
const u8 gText_OptionMenuCancel[] = _("{COLOR RED}{SHADOW LIGHT_GRAY}Exit");
...
const u8 gText_OptionMenuOn[] = _("{HIGHLIGHT WHITE}{COLOR GREEN}{SHADOW LIGHT_GRAY}{FONT 14}♂");
const u8 gText_OptionMenuOff[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}{FONT 14}¥");
const u8 gText_SaveRemind[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Show reminders to save at key moments");
const u8 gText_TxExp[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Explain obscure moves and Abilities");
...
const u8 gText_MenuPokedex[] = _("{COLOR RED}Pokédex");
...
const u8 gText_SavingPlayer[] = _("{COLOR BLUE}Player:");
const u8 gText_SavingBadges[] = _("{COLOR BLUE}Rank:");
const u8 gText_SavingPokedex[] = _("{COLOR BLUE}Pokédex:");
const u8 gText_SavingTime[] = _("{COLOR BLUE}Play time:");
const u8 gText_SavingPlayerName[] = _("{COLOR GREEN}{PLAYER}");
const u8 gText_SavingPlaceName[] = _("{COLOR RED}{STR_VAR_3}");
...
const u8 gText_Rank0[] = _("{COLOR RED}Trainee{COLOR DARK_GRAY}");
const u8 gText_Rank1[] = _("{COLOR RED}Recruit{COLOR DARK_GRAY}");
const u8 gText_Rank2[] = _("{COLOR RED}Officer{COLOR DARK_GRAY}");
const u8 gText_Rank3[] = _("{COLOR RED}Sergeant{COLOR DARK_GRAY}");
const u8 gText_Rank4[] = _("{COLOR RED}Detective{COLOR DARK_GRAY}");
const u8 gText_Rank5[] = _("{COLOR RED}Lieutenant{COLOR DARK_GRAY}");
const u8 gText_Rank6[] = _("{COLOR RED}Captain{COLOR DARK_GRAY}");
const u8 gText_Rank7[] = _("{COLOR RED}Commander{COLOR DARK_GRAY}");
const u8 gText_Rank8[] = _("{COLOR RED}Chief{COLOR DARK_GRAY}");
...
const u8 gText_RA_Goal_Title[] = _("{COLOR RED}NOPQ");
const u8 gText_RA_Goal_1_Line_1[] = _("Become a member of the");
const u8 gText_RA_Goal_1_Line_2[] = _("{COLOR RED}Amnesty Institute{COLOR DARK_GRAY}!");
