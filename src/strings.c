...
const u8 gText_MainMenuContinue[] = _(" Continuexyourzadventurezzzzzzzzzzzzzzzzzzzzzzzzzw"); // Yes, this is super janky
...
const u8 gText_Rank0[] = _("Trainee");
const u8 gText_Rank1[] = _("Recruit");
const u8 gText_Rank2[] = _("Officer");
const u8 gText_Rank3[] = _("Sergeant");
const u8 gText_Rank4[] = _("Detective");
const u8 gText_Rank5[] = _("Lieutenant");
