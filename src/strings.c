...
const u8 gText_SaveFileErased[] = _("Your save file had to be deleted due to\ncorruption or damage.");
const u8 gJPText_No1MSubCircuit[] = _("1Mサブきばんが ささっていません！");
const u8 gText_BatteryRunDry[] = _("The game thinks the internal battery in\nyour Game Boy Advance Game Pak has\lrun dry.\pThis usually means your emulator isn't\nset up correctly.\pYou can still play the game, but\nclock-based events won't take place.");
...
const u8 gText_PleaseResetTime[] = _("Use  {DPAD_NONE}  to set the correct time.");
const u8 gText_ClockHasBeenReset[] = _("Clock set. Updating your {COLOR RED}Mission Log{COLOR DARK_GRAY}...\nSaving. Don't close the emulator.");
const u8 gText_SaveCompleted[] = _("Your {COLOR RED}Mission Log{COLOR DARK_GRAY} is now up-to-date!");
const u8 gText_SaveFailed[] = _("Sorry, your game couldn't be saved. Your\nemulator might not be set up correctly.");
