...
const u8 gText_SaveFileCorrupted[] = _("Sorry, but your save file is corrupted.\nWe'll load your previous save instead.");
const u8 gText_SaveFileErased[] = _("We're so sorry, but your save file was\ndeleted due to damage or corruption.");
...
const u8 gText_ClearAllSaveData[] = _("Delete your adventure? Your progress,\nitems and Pokémon will be {COLOR BLUE}lost forever{COLOR DARK_GRAY}.");
const u8 gText_ClearingData[] = _("Goodbye!");
