...
static const u8 sTextColor_Headers[] = {TEXT_DYNAMIC_COLOR_1, TEXT_COLOR_BLUE, TEXT_COLOR_LIGHT_BLUE};
static const u8 sTextColor_MenuInfo[] = {TEXT_DYNAMIC_COLOR_1, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY};
static const u8 sTextColor_PlayerName[] = {TEXT_DYNAMIC_COLOR_1, TEXT_COLOR_GREEN, TEXT_COLOR_LIGHT_GREEN};
    ...
    if (!gPaletteFade.active)
    {
        ...
        switch (gTasks[taskId].tMenuType)
        {
            ...
            default:
                ...
                AddTextPrinterParameterized3(0, FONT_NORMAL_SUBPIXEL, 0, 1, sTextColor_Headers, TEXT_SKIP_DRAW, gText_MainMenuNewGame);
                AddTextPrinterParameterized3(1, FONT_NORMAL_SUBPIXEL, 0, 1, sTextColor_Headers, TEXT_SKIP_DRAW, gText_MainMenuOption);
                PutWindowTilemap(0);
                PutWindowTilemap(1);
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_HOOPA);
...
{
    return CreateMonPicSprite_Affine(SPECIES_HOOPA, SHINY_ODDS, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
...
static void CreateMainMenuErrorWindow(const u8 *str)
{
    ...
    AddTextPrinterParameterized(7, FONT_NORMAL_SUBPIXEL, str, 0, 1, 2, 0);
    PutWindowTilemap(7);
...
static void MainMenu_FormatSavegamePokedex(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        if (IsNationalPokedexEnabled())
            dexCount = GetNationalPokedexCount(FLAG_GET_SEEN);
        else
...
{
    u8 bgColor = GetFontAttribute(FONT_NORMAL_SUBPIXEL, FONTATTR_COLOR_BACKGROUND);
    u8 maxCharWidth = GetFontAttribute(FONT_NORMAL_SUBPIXEL, FONTATTR_MAX_LETTER_WIDTH);
    u8 maxCharHeight = GetFontAttribute(FONT_NORMAL_SUBPIXEL, FONTATTR_MAX_LETTER_HEIGHT);
