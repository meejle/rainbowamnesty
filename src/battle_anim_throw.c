...
#define TAG_PARTICLES_HOOPABALL   65057
...
static const struct CompressedSpriteSheet sBallParticleSpriteSheets[] =
{
    ...
    [BALL_HOOPA]    = {gBattleAnimSpriteGfx_Particles2,     0x100, TAG_PARTICLES_ULTRABALL},
};
...
static const struct CompressedSpritePalette sBallParticlePalettes[] =
{
    ...
    [BALL_HOOPA]    = {gBattleAnimSpritePal_CircleImpact,   TAG_PARTICLES_ULTRABALL},
};
...
static const TaskFunc sBallParticleAnimationFuncs[POKEBALL_COUNT] =
{
    ...
    [BALL_HOOPA]   = UltraBallOpenParticleAnimation,
};
