...
EWRAM_DATA static u16 ALIGNED(2) sFieldEffectPaletteColorMapTypes[32] = {0};

static const u16 *sPaletteColorMapTypes;
...
EWRAM_DATA u16 __attribute__((aligned(16))) sBasePaletteColorMapTypes[32] =
{
    // background palettes
...
static void BuildColorMaps(void)
{
    ...
    for (i = 0; i <= 12; i++)
        sBasePaletteColorMapTypes[i] = COLOR_MAP_NONE;
